...
> Synced to live: **2026-05-31 ~03:25 SGT** (contest ends 31 May 10:00 SGT — ~6.5h left).
> Team **CoolBingo** (id 45) — **score 4974, place 76th**. **Solved 18/35.**
...
| challenge | cat | id | val | flag |
|-----------|-----|----|-----|------|
| [AE-no-S](challenges/ezpz/01_ae-no-s/) | ezpz | 7 | 100 | `grey{iT5_4LL_l1N3R_aLGyBeR?...}` |
| [babyheap](challenges/ezpz/03_babyheap/) | ezpz | 20 | 100 | ✅ (flag in CTFd) |
| [babyRSA](challenges/ezpz/04_babyrsa/) | ezpz | 21 | 100 | `grey{th1s_15_pr0b4bly_t00_34sy_n0w4d4y5_1n34v80n23}` |
| [my-greycat](challenges/ezpz/05_my-greycat/) | ezpz | 24 | 100 | ✅ (flag in CTFd) |
| [Codex Computer Use](challenges/ezpz/07_codex-computer-use/) | ezpz | 29 | 100 | `grey{be_careful_when_sh4ring_agent_traces!1!}` |
| [Fort Knockies](challenges/ezpz/08_fort-knockies/) | ezpz | 30 | 100 | `grey{jz_some_rookie_mistakesi9v2k}` |
| [Say My Name](challenges/ezpz/02_say-my-name/) | ezpz | 19 | 508 | teammate (alien≈Bibble) |
| [Duality in All Things](challenges/ai/03_duality-in-all-things/) | ai | 5 | 100 | `grey{du4l_0pt1m1z4t10n_l3ft_th3_supp0rt_v3ct0rs_b3h1nd}` |
| [Jurgen's Revenge](challenges/ai/02_jurgen-s-revenge/) | ai | 4 | 100 | `grey{h1y4_there_n3el_n4nda_d1dnt_s3e_y0u_0ver_fr0m_ov3r_h3re}` |
| [filter_flag](challenges/crypto/01_filter-flag/) | crypto | 14 | 100 | ✅ (flag in CTFd) |
| [caexor](challenges/crypto/02_caexor/) | crypto | 15 | 499 | `grey{why_lattice_enumerate_when_you_can_bkz}` (lattice/BKZ preimage) |
| [Wait a minute](challenges/misc/02_wait-a-minute/) | misc | 9 | 100 | ✅ (flag in CTFd) |
| [An old soviet terminal](challenges/misc/01_an-old-soviet-terminal/) | misc | 8 | 875 | ✅ (user solved) |
| [Training Shooting Flags](challenges/misc/04_training-shooting-flags/) | misc | 36 | 852 | `grey{lmao_imagine_revvin}` |
| [elite ball knowledge](challenges/pwn/01_elite-ball-knowledge/) | pwn | 16 | 655 | `grey{3l1t3_b4lL_kn0wLedge_is_just_more_syscalls}` |
| [spidr](challenges/rev/03_spidr/) | rev | 27 | 100 | `grey{4022823573008984730}` |
| [Gopher's Adventure!](challenges/rev/05_gophers-adventure/) | rev | 39 | 385 | `grey{G0pHeR_g0e5_oN_4N_4dv3ntur3!XDDDD}` |
| [GreyCat Game](challenges/web/05_greycat-game/) | web | 28 | 100 | `grey{you_better_run_bruno_cat}` |
